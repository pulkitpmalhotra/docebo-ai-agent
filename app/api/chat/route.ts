...
class IntentAnalyzer {
  static analyzeIntent(message: string): {
    ...
    // Intent patterns with confidence scores
const patterns = [
  // Specific enrollment check patterns - HIGHEST PRIORITY
  {
    ...
    extractEntities: () => {
      // Extract email, course/learning plan name, and check type
