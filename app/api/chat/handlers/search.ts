...
💡 **Possible reasons**: 
• Additional field endpoints not available on this Docebo instance
• Manager information not configured in user additional fields
• API permissions limited for enhanced user data`;
